...
parser = argparse.ArgumentParser(description='Run stereo evaluation set')
...
if os.path.isdir(args.working_dir):
    if args.motion is None:
        print ''
        print '==========================================='
        print 'Full motion+FOV dataset stereo evaluation'
        print '==========================================='
    else:
        print ''
        print '==========================================='
        print '{} motion dataset stereo evaluation'.format(args.motion)
        print '==========================================='
    fovs = []
            ...
            for fov in fovs:
                ...
                for filename in os.listdir(bag_dir):
                    if filename.endswith('.bag') and not filename.endswith('.orig.bag'):
                        ...
                        sys.argv = ['roslaunch', 'omni_slam_eval', 'stereo_eval.launch', 'bag_file:={}'.format(bag_file), 'camera_file:={}'.format(fov_file)]
                        reload(roslaunch)
                        roslaunch.main()
    print ''
    print '==================='
