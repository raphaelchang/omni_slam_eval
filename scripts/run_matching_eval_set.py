...
det_param_map = dict()
det_param_map['SIFT'] = '{nfeatures: 100}'
det_param_map['SURF'] = '{hessianThreshold: 5000}'
det_param_map['ORB'] = '{nfeatures: 10}'
det_param_map['BRISK'] = '{thresh: 100}'
